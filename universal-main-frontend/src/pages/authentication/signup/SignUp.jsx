...
const getInputClass = (field, errors) =>
  ...
  } rounded-xl text-white placeholder-blue-300/60 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm`;
...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(finalErrors).length === 0 && acceptTerms) {
      setIsLoading(true);
      setTimeout(() => {
        setIsLoading(false);
        ...
        <div className="hidden lg:flex flex-col justify-center px-10 py-8 border-r border-white/10">
          ...
          <div className="space-y-3">
            {steps.map((step) => (
              <div
                key={step.num}
                className={`flex items-center gap-3 p-3 rounded-xl transition-all ${currentStep === step.num ? "bg-white/15 border border-white/20" : "opacity-50"}`}
              >
                <div
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="00100"
                      className="w-full px-4 py-2.5 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-300/60 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm"
                    />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-white/10 border border-white/20 rounded-xl text-white placeholder-blue-300/60 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm"
                      />
                    </div>
                  </div>
                  <SelectInput
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="••••••••"
                        className={`w-full pl-10 pr-10 py-2.5 bg-white/10 border ${errors.adminPassword ? "border-red-400" : "border-white/20"} rounded-xl text-white placeholder-blue-300/60 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm`}
                      />
                      <button
                        type="button"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="••••••••"
                        className={`w-full pl-10 pr-10 py-2.5 bg-white/10 border ${errors.adminConfirmPassword ? "border-red-400" : "border-white/20"} rounded-xl text-white placeholder-blue-300/60 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm`}
                      />
                      <button
                        type="button"
                        onClick={() =>
              ...
              {currentStep === 3 && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <div className="flex items-center gap-4 p-4 bg-white/5 border border-white/15 rounded-xl">
                      <div className="w-16 h-16 bg-white/10 rounded-xl border-2 border-dashed border-white/30 flex items-center justify-center overflow-hidden flex-shrink-0">
                        {logoPreview ? (
                          <img
                            src={logoPreview}
                            alt="Logo"
                      ...
                      <div className="flex-1 min-w-0">
                        <input
                          ...
                          onChange={handleInputChange}
                          accept="image/*"
                          className="w-full text-xs text-blue-200 file:mr-3 file:py-2 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700"
                        />
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      className={`w-full px-4 py-2.5 bg-white/10 border ${errors.businessDescription ? "border-red-400" : "border-white/20"} rounded-xl text-white placeholder-blue-300/60 focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none text-sm`}
                    />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        min="1"
                        className={`w-full pl-10 pr-4 py-2.5 bg-white/10 border ${errors.numberOfStores ? "border-red-400" : "border-white/20"} rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm`}
                      />
                    </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    {subscriptionPlans.map((plan) => (
                      <div
                        ...
                        className={`relative p-5 rounded-xl border-2 cursor-pointer transition-all ${formData.subscriptionPlan === plan.id ? "border-blue-500 bg-blue-600/20" : "border-white/20 bg-white/5 hover:bg-white/10"}`}
                      >
                        {plan.popular && (
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                      {[
                        ...
                        <label
                          key={opt.val}
                          className={`flex items-center gap-3 p-4 rounded-xl border-2 cursor-pointer transition-all ${formData.paymentMethod === opt.val ? "border-blue-500 bg-blue-600/20" : "border-white/20 bg-white/5"}`}
                        >
                          <input
                            type="radio"
                            name="paymentMethod"
              ...
              <div>
                {currentStep > 1 && (
                  <button
                    ...
                    className="px-5 py-2.5 bg-white/10 text-white rounded-xl font-semibold hover:bg-white/20 transition-all text-sm"
                  >
                    ← Previous
                  </button>
                )}
              ...
              <div className="flex items-center gap-3">
                ...
                {currentStep < 4 ? (
                  <button
                    type="button"
                    onClick={handleNext}
                    className="px-6 py-2.5 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-all flex items-center gap-2 text-sm"
                  >
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition-all flex items-center gap-2 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isLoading ? (
                      <>
