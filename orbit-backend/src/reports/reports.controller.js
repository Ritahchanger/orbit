...
class ReportController {
  ...
  async getSalesReport(req, res) {
    ...
    const salesReport = await reportService.getSalesReport(filters, businessId);
  ...
  async getInventoryReport(req, res) {
    ...
    const businessId = req.businessId;
    const inventoryReport = await reportService.getInventoryReport(filters, businessId);
  ...
  async getProductPerformanceReport(req, res) {
    const { startDate, endDate, storeId, category, limit = 20 } = req.query;
    ...
    const businessId = req.businessId;
    const productReport =
      await reportService.getProductPerformanceReport(filters, businessId);
  ...
  async getStorePerformanceReport(req, res) {
    ...
    const storeReport = await reportService.getStorePerformanceReport(
      filters,
      businessId,
    );
  ...
  async getSalesTrendReport(req, res) {
    try {
      const { period = "daily", startDate, endDate, storeId } = req.query;
      const businessId = req.businessId;
      ...
      const salesTrend = await reportService.getSalesTrendReport(
        period,
        filters,
        businessId,
      );
  ...
  async getLowStockAlerts(req, res) {
    ...
    const lowStockReport = await reportService.getInventoryReport(filters, req.businessId);
  ...
  async getOutOfStockReport(req, res) {
    ...
    const outOfStockReport = await reportService.getInventoryReport(filters, req.businessId);
  ...
  async getPaymentMethodAnalysis(req, res) {
    ...
    const totalAmount = paymentAnalysis.reduce(
      (sum, item) => sum + item.totalAmount,
      0,
    );
    const totalTransactions = paymentAnalysis.reduce(
  ...
  async getMonthlySalesSummary(req, res) {
    try {
      ...
      const data = await reportService.getMonthlySalesSummary({
        year,
        month,
        storeId,
        businessId,
