import { Mail, AlertCircle, LogIn, Eye, EyeOff, Lock, Shield, Phone, KeyRound, RefreshCw } from "lucide-react"
                            ...
                            <>
                                <div>
                                    ...
                                    <div className="mt-3 flex items-center justify-between">
                                        ...
                                        >
                                            <RefreshCw className={`h-4 w-4 mr-1 ${otpResendCooldown === 0 && 'animate-pulse'}`} />
                                            {otpResendCooldown > 0
                                ...
                                <div className="p-3 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-sm">
                                    <p className="text-xs text-gray-600 dark:text-gray-400">
                                        <span className="text-green-600 dark:text-green-400 font-medium">✓ OTP Sent:</span> Check your email for the 6-digit verification code. It will expire in 10 minutes.
                                    </p>
                                </div>
                            </>
                        )}
