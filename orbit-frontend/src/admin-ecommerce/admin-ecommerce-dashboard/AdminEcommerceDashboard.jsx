...
import { paymentMethods, categories } from "../../admin-pages/products/data";
import AdminAllProducts from "../../admin-pages/products/components/AdminAllProducts";
import AdminProductsFooterActions from "../../admin-pages/products/components/AdminProductsFooterActions";
import AdminProductsDeleteConfirmationModal from "../../admin-pages/products/components/AdminProductsDeleteConfirmationModal";
import AdminProductsSearchFilters from "../../admin-pages/products/components/AdminProductsSearchFilters";
import AdminProductsHeader from "../../admin-pages/products/components/AdminProductsHeader";
import {
  ProductSkeletonLoader,
  StatsSkeletonLoader,
} from "../../admin-pages/products/preloaders/ProductsPreloader";
...
import {
  ...
  useCreateProduct,
  productKeys,
} from "../../admin-pages/hooks/product.hooks";
