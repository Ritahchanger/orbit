...
import { getAllowedEcommerceNavItems } from "./data";

import { useDispatch } from "react-redux";

import { toast } from "react-hot-toast";

import { openModal } from "../../admin-pages/products/redux/add-product-modal-slice";

import AdminSearchModal from "../../admin-pages/dashboard/components/AdminSearchModal";

import ShowUserMenu from "../../admin-pages/dashboard/components/ShowUserMenu";

import MobileMenuOpen from "../../admin-pages/dashboard/components/MobileMenuOpen";

import AdminStoresLoading from "../../admin-pages/dashboard/components/AdminStoresLoading";

import Logo from "../../admin-pages/dashboard/layout/Logo";

import CustomerAvatar from "../../admin-pages/customers/CustomerAvatar";

import ThemeButton from "../../admin-pages/dashboard/layout/ThemeButton";

const AdminEcommerceNavbar = () => {
  ...
  useEffect(() => {
    if (userRole) {
      const filteredItems = getAllowedEcommerceNavItems(userRole);
  ...
  return (
    <>
      {/* Admin Ecommerce Navbar - Matching POS theme */}
      <nav className="fixed top-0 z-40 w-full bg-linear-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* Add Product Button - Only for superadmin (Ecommerce specific) */}
              {userRole === "superadmin" && (
                <button
              ...
              {/* Ecommerce Reports Link - Different color for distinction */}
              {(userRole === "superadmin" || userRole === "admin") && (
                <Link
                  to="/admin/ecommerce/reports"
                  className="hidden md:flex items-center gap-2 px-4 py-2.5 rounded-sm bg-linear-to-r from-purple-600 to-pink-600 text-white hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-200"
                >
                  <TrendingUp size={16} />
              ...
              {/* Switch to POS Link - For superadmin and admin */}
              {(userRole === "superadmin" || userRole === "admin") && (
                <Link
                  to="/admin/dashboard"
        ...
        {/* STORE STRIP - Bottom of Navbar (Same as POS) */}
        <AdminStoresLoading
...
export default AdminEcommerceNavbar;
