import AdminEcommerceNavbar from "./EcommerceNavbar";

import { useLocation, useNavigate } from "react-router-dom";

import ShortcutsOverlay from "../../admin-pages/dashboard/layout/ShortcutsOverlay";

import SystemHelperModal from "../../admin-pages/dashboard/layout/SystemHelperModal";

import { useStoreSelectionModal } from "../../admin-pages/hooks/useStoreSelectionModal";

import { useEffect, useState } from "react";

import { useAuth } from "../../context/authentication/AuthenticationContext";

import AdminGlobalButtons from "../../admin-pages/dashboard/layout/AdminGlobalButtons";

import CalculatorModal from "../../admin-pages/modals/CalculatorModal";

import StoreSelectionModal from "../../admin-pages/modals/StoreSelectionModal";

const AdminEcommerceLayout = ({ children }) => {
...
export default AdminEcommerceLayout;
