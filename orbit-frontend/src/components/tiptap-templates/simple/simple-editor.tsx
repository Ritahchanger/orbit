...
interface SimpleEditorProps {
  ...
  /**
   * Whether to show image upload functionality
   * @default true
   */
  ...
  className?: string
  /**
   * Custom class name for the editor content area
   */
    ...
    <div className={`simple-editor-wrapper ${className}`}>
      <EditorContext.Provider value={{ editor }}>
        ...
        <EditorContent
          editor={editor}
          role="presentation"
          className={`simple-editor-content ${contentClassName}`}
        />
