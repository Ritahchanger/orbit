...
api.interceptors.response.use(
  ...
  (error) => {
    ...
    switch (status) {
      ...
      case 403:
        return Promise.reject(new Error(message || "You don't have permission for this action"));
      case 404:
      ...
      case 429:
        return Promise.reject(new Error(message || "Too many requests - please slow down"));
      case 500:
      ...
      case 503:
      case 504:
        return Promise.reject(new Error(message || "Service temporarily unavailable"));
      default:
